...
class Salaires {
    public static void main(String[] args) {
        ...
        p.ajouterEmploye(new Vendeur("95Q001","ALI", "PELE", 45, "1995", 30000));
        p.ajouterEmploye(new Representant("01Q100","NASSOUR", "ANNOUR", 25, "2001", 20000));
        p.ajouterEmploye(new Technicien("98Q002","TCHAFROS", "TCHAFROS", 28, "1998", 1000));
        p.ajouterEmploye(new Manutentionnaire("98Q003","ANNI", "NIMERY", 32, "1998", 45));
        p.ajouterEmploye(new TechnARisque("00Q025","ISSA", "YAYA", 28, "2000", 1000));
        p.ajouterEmploye(new ManutARisque("01Q102","MAHAMAT", "ALI", 30, "2001", 45));
